...
Texture::Texture(void* data, int w, int h, int format, int internal)
:m_width(w), m_height(w)
{
    glGenTextures(1, &m_Id);
	glBindTexture(GL_TEXTURE_2D, m_Id);
    glTexImage2D(GL_TEXTURE_2D, 0, format, m_width, m_height, 0, internal, GL_UNSIGNED_BYTE, data);
